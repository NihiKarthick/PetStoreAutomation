...
public class User_Test2 {
 ...
 public Logger logger;
	...
	public void test_post() {
		...
		Response createUser = UserEndpoints2.CreateUser(userpayload);
	...
	public void test_getuser() {
		...
		Response readUser = UserEndpoints2.ReadUser(this.userpayload.getUsername());
	...
	public void test_update() {
		...
		Response updateUser = UserEndpoints2.UpdateUser(this.userpayload.getUsername(),userpayload);
		...
		Response AfterupdateUser = UserEndpoints2.UpdateUser(this.userpayload.getUsername(),userpayload);
